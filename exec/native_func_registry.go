...
import (
	...
	"rice/exec/fun"
	"rice/exec/mem"
	_datetime "rice/exec/stdlib/datetime"
	_error "rice/exec/stdlib/error"
	_io "rice/exec/stdlib/io"
	_list "rice/exec/stdlib/list"
	_map "rice/exec/stdlib/map"
	_math "rice/exec/stdlib/math"
	_set "rice/exec/stdlib/set"
	_string "rice/exec/stdlib/string"
	_type "rice/exec/stdlib/type"
	"rice/exec/types"
